<?php
    ...
    $sql = "SELECT product_name, quantity FROM inventory WHERE product_name IN ('Pringles', 'Hershey Bar', 'Lays Chips', 'Coca-Cola', 'Red Bull', 'Sparkling Water', 'iPhone Charger', 'Cigarettes', 'Chapstick')";
    $result = $conn->query($sql);

    $quantity = array();
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            $quantity[$row['product_name']] = $row['quantity'];
        }
    }
    ...
    foreach ($items as $item) {
        if (!isset($quantity[$item])) {
            $quantity[$item] = 'Stock not available';
        }
    }
?>
<!DOCTYPE html>
...
<body>
    <header>
        ...
        .product-image {
            ...
            object-fit: cover; /* This property helps maintain the aspect ratio of the image */
        }
    </style>
    </header>
    <main>
        <div class="filters">
            ...
            <div id="products">
                <div class="product">
                    ...
                    <img src="pringle.jpg" alt="Pringles Image" class="product-image pringlesPack-image">
                ...
                <div class="product">
                <div class="product-container">
                    <img src="hershey.jpg" alt="Hershey Bar Image" class="product-image hersheyChocolate-image">
                ...
                <div class="product">
                <div class="product-container">
                    <img src="lays.jpg" alt="Lays Chips Image" class="product-image">
                ...
                <div class="product">
                <div class="product-container">
                    <img src="coke.jpg" alt="Coca-Cola Image" class="product-image">
                ...
                <div class="product">
                <div class="product-container">
                    <img src="redbull.jpg" alt="Red Bull Image" class="product-image">
                ...
                <div class="product">
                <div class="product-container">
                    <img src="water.jpg" alt="Sparkling-Water Image" class="product-image">
                ...
                <div class="product">
                <div class="product-container">
                    <img src="charger.jpg" alt="iPhone Charger Image" class="product-image">
                ...
                <div class="product">
                <div class="product-container">
                    <img src="cigarette.jpg" alt="Cigarettes Image" class="product-image">
                ...
                <div class="product">
                <div class="product-container">
                    <img src="chapstick.jpg" alt="Chapstick Image" class="product-image">
    ...
    checkoutButton.addEventListener('click', function () {
        ...
        localStorage.setItem('cartItems', JSON.stringify(cart));
        window.location.href = 'http://localhost/checkout.php'; // Redirect to checkout
    });
    ...
    updateCart();
    // ... (Existing code for filtering products and other functionalities)
    //========== To filter the items ==========
